...
/// <summary>
/// AutoCAD 2025 版本的插件入口点。
/// 继承 <see cref="PluginEntryBase"/>，提供 2025 版本特定的平台常量、字体 Hook 和宿主实现。
/// </summary>
public class PluginEntry : PluginEntryBase
{
    /// <inheritdoc />
    protected override ICadPlatform CreatePlatform() => new AutoCad2025Platform();
    /// <inheritdoc />
