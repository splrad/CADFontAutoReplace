...
/// </summary>
internal sealed class AutoCad2025Platform : ICadPlatform, INativeFontHookExportsProvider
{
    public string BrandName => "AutoCAD";
    public string VersionName => "2025";
    public string AppName => "AFR-ACAD2025";
    public string DisplayName => "AutoCAD 2025";
    public string RegistryBasePath => @"Software\Autodesk\AutoCAD\R25.0";
