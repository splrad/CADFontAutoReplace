    ...
    public NativeFontHookProfile NativeFontHookProfile
        => new(
            NativeHookTarget.Export(
                ...
                0x373AEC,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0x25, 0xCE, 0xC2, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
            ...
            NativeHookTarget.Export(
                ...
                0x373D38,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0xD1, 0xCB, 0xC2, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "AcGiTextStyle::setBigFontFileName",
                AcGiTextStyleSetBigFontFileNameExport,
                0x373D14,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0xF5, 0xCB, 0xC2, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "AcGiTextStyle::AcGiTextStyle(font,bigFont)",
                AcGiTextStyleFileNameCtorExport,
                0x71EE84,
                [0x48, 0x8B, 0xC4, 0x48, 0x89, 0x48, 0x08, 0x41, 0x56, 0x48, 0x81, 0xEC, 0x90, 0x00, 0x00, 0x00],
                maxPrologueSize: 96),
            NativeHookTarget.Export(
                "AcDbMText::explodeFragments",
                AcDbMTextExplodeFragmentsExport,
                0x9B09A0,
                [0x48, 0x8B, 0xC1, 0x33, 0xC9, 0x48, 0x85, 0xC0, 0x74, 0x04, 0x48, 0x8B, 0x48, 0x10, 0xE9, 0xDD],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "ldfile",
                LdFileExport,
