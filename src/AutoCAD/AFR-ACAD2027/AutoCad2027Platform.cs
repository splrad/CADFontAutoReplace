    ...
    public NativeFontHookProfile NativeFontHookProfile
        => new(
            NativeHookTarget.Export(
                ...
                0x136920,
                [0x48, 0x8B, 0x49, 0x08, 0x48, 0x8B, 0x49, 0x08, 0xE9, 0x03, 0x00, 0x00, 0x00, 0xCC, 0xCC, 0xCC],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
            ...
            NativeHookTarget.Export(
                ...
                0xB39EA4,
                [0x48, 0x8B, 0xC1, 0x33, 0xC9, 0x48, 0x85, 0xC0, 0x74, 0x04, 0x48, 0x8B, 0x48, 0x08, 0xE9, 0xB5],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "ldfile",
                LdFileExport,
