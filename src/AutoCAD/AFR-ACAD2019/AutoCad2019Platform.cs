    ...
    public NativeFontHookProfile NativeFontHookProfile
        => new(
            NativeHookTarget.Export(
                ...
                0x4C580,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0x19, 0xF3, 0xC6, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
            ...
            NativeHookTarget.Export(
                ...
                0x4C560,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0x41, 0xF3, 0xC6, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "AcGiTextStyle::setBigFontFileName",
                AcGiTextStyleSetBigFontFileNameExport,
                0x4C520,
                [0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xDA, 0xFF, 0x15, 0x81, 0xF3, 0xC6, 0x00, 0x48],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
            ...
            NativeHookTarget.Export(
                ...
                0xBCFD20,
                [0x48, 0x8B, 0xC1, 0x33, 0xC9, 0x48, 0x85, 0xC0, 0x74, 0x04, 0x48, 0x8B, 0x48, 0x10, 0xE9, 0x7D],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "ldfile",
                LdFileExport,
