...
/// </summary>
internal sealed class AutoCad2023Platform : ICadPlatform, INativeFontHookExportsProvider
{
    public string BrandName => "AutoCAD";
    public string VersionName => "2023";
    public string AppName => "AFR-ACAD2023";
    public string DisplayName => "AutoCAD 2023";
    public string RegistryBasePath => @"Software\Autodesk\AutoCAD\R24.2";
    ...
    public NativeFontHookProfile NativeFontHookProfile
        => new(
            ...
            NativeHookTarget.Export(
                ...
                0xA20178,
                [0x48, 0x8B, 0xC1, 0x33, 0xC9, 0x48, 0x85, 0xC0, 0x74, 0x04, 0x48, 0x8B, 0x48, 0x10, 0xE9, 0xB1],
                maxPrologueSize: 64),
            NativeHookTarget.Export(
                "ldfile",
                LdFileExport,
