...
这些 Hook 只生产文枢强信号证据，不直接修正文本文字、不直接改 native code page。当前只在 AutoCAD 2025 / `acdb25.dll` 已验证路径启用，其它版本应 fail closed。
...
- [ ] Hook on/off 两条路径验证
- [ ] AutoCAD 2025 / `acdb25.dll` 的 DBText native evidence Hook 已安装并产生证据；其它版本 fail closed
