...
from afr_glyphcore.candidates import build_candidates  # noqa: E402
...
class V4FeatureAndCandidateTests(unittest.TestCase):
    def test_hook_raw_candidate_is_prioritized_and_featured(self) -> None:
        ...
        self.assertEqual(98, FEATURE_COUNT)
        self.assertEqual("dbtext-ai-features-v4", FEATURE_SCHEMA_VERSION)
    ...
    def test_symbols_ascii_and_ripple_features_survive_feature_build(self) -> None:
        ...
        feature_columns = [key for key in rows[0] if re.match(r"^f\d{2}_", key)]
