...
from afr_glyphcore.candidates import build_candidates, make_corrupted_current  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate synthetic AFR GlyphCore DBText seed labels.")
